...
from .views.address_view import GenerateAddress,GetAddressByUser, ImportAddress, GetAddressInfo, GetAllUTXOByAddress
urlpatterns = [
  ...
  path("api/v1/importaddress/<address>",ImportAddress.as_view()),
